...
class U1(nn.Module):
    def __init__(self, in_channels):
        ...
        self.channle = ChanleBlock(in_channels, in_channels // 2)
        self.conv = ConvBNReLU(in_channels // 2, in_channels // 2)
        self.channle1 = ChanleBlock(in_channels // 2, in_channels // 4)
...
class MPU_net(nn.Module):
    def __init__(self, backbone, num_classes=2):
        super(MPU_net, self).__init__()
...
def mpunet(pretrain_backbone=False):
