...
class U1(nn.Module):
    def __init__(self, in_channels):
        ...
        self.con = nn.Conv2d(in_channels, in_channels // 2, kernel_size=3)
        self.conv = ConvBNReLU(in_channels // 2, in_channels // 2)
        self.con1 = nn.Conv2d(in_channels // 2, in_channels // 4, kernel_size=3)
...
class MPU_netx(nn.Module):
    def __init__(self, backbone, num_classes=2):
        super(MPU_netx, self).__init__()
...
def mpunetx(pretrain_backbone=False):
