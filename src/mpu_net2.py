...
class MPU_net2(nn.Module):
    def __init__(self, backbone, num_classes=2):
        super(MPU_net2, self).__init__()
...
def mpunet2(pretrain_backbone=False):
